...
REPO_API="https://api.github.com/repos/mediaselect/select-freeboxos/commits/master"
...
wget https://github.com/mediaselect/select-freeboxos/archive/refs/heads/master.zip -O /tmp/master_select_freeboxos.zip
if [ $? -ne 0 ]; then
...
mv "$HOME/select-freeboxos-master" "$HOME/select-freeboxos"
